...
locals {
  ...
  karpenter-version = "1.0.50"

  xquare-application-name    = "xquare-application"
  xquare-application-version = "1.0.31"
...
module "karpenter" {
  ...
  irsa_oidc_provider_arn = "arn:aws:iam::471407337433:role/KarpenterControllerRole-xquare-v2-cluster"
